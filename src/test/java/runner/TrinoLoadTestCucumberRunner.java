...
@CucumberOptions(
		dryRun=false
		,features = "src/test/resources/load_tests"
		,glue = {"glue.stepdef.load"}
...
public class TrinoLoadTestCucumberRunner /*extends AbstractTestNGCucumberTests*/ {
...
//	}
	...
	public void setUpClass(ITestContext context) {
		Log.info("Load Tests are starting!");
//		XmlTest currentXmlTest = context.getCurrentXmlTest();
//		Objects.requireNonNull(currentXmlTest);
//		CucumberPropertiesProvider properties = currentXmlTest::getParameter;
		//startTest("Locust Load testing for Trino", "Locust Load testing for Trino");
